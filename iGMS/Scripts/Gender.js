...
function Gender(pagenum, page, seach) {
    $.ajax({
        url: '/gender/List',
        type: 'get',
        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += '<a class="nav-link" href="/Gender/Edits/' + v.id + '">';
...
function Add() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                Swal.fire({
                    title: "Tạo Giới Tính Thành Công",
                    icon: "success",
                ...
                window.location.href = "/Gender/Index";
            } else if (data.code == 300) {
                alert(data.msg)
            }
            else {
                alert("Tạo Giới Tính Thất Bại")
            }
        }
    })
}
...
function Edit() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                Swal.fire({
                    title: "Sửa Giới Tính Thành Công",
                    icon: "success",
                    buttonsStyling: false,
                    confirmButtonText: "Confirm me!",
                    customClass: {
    ...
    if (confirm("Bạn Muốn Xóa Dữ Liệu Này ???")) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 200) {
                    Swal.fire({
                        title: "Xóa Giới Tính Thành Công",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Confirm me!",
                        customClass: {
