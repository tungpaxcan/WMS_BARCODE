        ...
        success: function (data) {
            ...
            if (data.code == 200) {
                $.each(data.c, function (k, v) {
                    ...
                    table += `<a class="nav-link" onclick="check_Role('${string} ','${v.id }', 'EditGroupGoods')">`;
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                setTimeout(function () { window.location.href = "/GroupGoods/Index" }, 1000);
...
$(document).on('click', 'a[name="delete"]', function () {
    ...
    formData.append("function", 'DeleteGroupGoods');
